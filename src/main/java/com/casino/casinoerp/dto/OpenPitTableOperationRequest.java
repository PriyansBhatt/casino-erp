...
public record OpenPitTableOperationRequest(
        @NotEmpty(message = "Opening denominations are required") @com.fasterxml.jackson.databind.annotation.JsonDeserialize(contentUsing = StrictBuyInQuantityDeserializer.class)
        ...
        @jakarta.validation.constraints.NotNull java.time.LocalDate expectedBusinessDate) {
}
